        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="group flex items-center space-x-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 px-5 py-2 rounded-xl text-sm font-medium text-white shadow-lg hover:shadow-green-500/30 transition-all duration-300 transform hover:scale-105"
            >
              <UserPlusIcon className="w-4 h-4 group-hover:rotate-12 transition-transform duration-300" />
              <span>Add Admin</span>
            </button>
