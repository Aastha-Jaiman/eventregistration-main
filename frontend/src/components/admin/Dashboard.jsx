...
const Dashboard = () => {
  ...
  const handleDownloadUserData = (user) => {
    ...
    const exportFileDefaultName = `${user.email}_data.json`;
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg font-medium hover:from-green-600 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-sm"
                >
                ...
                <div className="text-sm text-blue-800">
                  ...
                  {Math.min(endIndex, sortedUsers.length)} of{" "}
                  {sortedUsers.length}
                </div>
              </div>
            </div>
