...
const UserDetailModal = ({ user, onClose }) => {
  ...
  const handleExport = () => {
    const dataToExport = userDetails || user;
    const exportData = [
      {
        "Full Name": dataToExport.fullname || "",
        Email: dataToExport.email || "",
        Phone: dataToExport.phone || "",
        City: dataToExport.city || "",
        "Company Name": dataToExport.companyName || "",
        "Company Address": dataToExport.companyAddress || "",
        Role: dataToExport.role || "",
        "Stall Number":
          dataToExport.role === "executive"
            ? dataToExport.stallNumber || ""
            : "",
        "Account Created": dataToExport.createdAt
          ? new Date(dataToExport.createdAt).toLocaleDateString("en-US", {
              year: "numeric",
              month: "long",
              day: "numeric",
              hour: "2-digit",
          ...
          : "",
        "Last Updated":
          dataToExport.updatedAt || dataToExport.createdAt
            ? new Date(
                dataToExport.updatedAt || dataToExport.createdAt
    ...
    const fileName = `${dataToExport.fullname || "user"}_data_${
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <InfoCard
                    ...
                    value={displayUser.companyAddress}
                  />
                  <InfoCard
                    icon={ShieldIcon}
                    label="Role"
                  ...
                  />
                  {displayUser.role === "exhibitor" && (
                    <InfoCard
                      icon={HashIcon}
                      label="Stall Number"
                      value={displayUser.stallNumber}
                    />
                  )}
                </div>
              </div>
